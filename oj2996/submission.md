...
is string
output:
is input but backward
constraints:
Just use [::-1] to turn input backward and use if to make it only run when input is 5 letters word.
```
...
```text
step 1. get input
step 2. make input turn into lowercase
step 3. turn input backward by [::-1]
step 4. see if input is 5 letters word
step 5. print
```
...
```text
I use like step i just describe.
```
